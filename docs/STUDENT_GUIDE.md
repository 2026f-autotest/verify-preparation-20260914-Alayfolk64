...
点击[领取作业仓库](https://github.com/2026f-autotest/enroll/issues/new?template=enroll.yml)，选择 **2074** 并提交 Issue。系统自动读取申请人账号；等待机器人回复，打开回复里的邀请链接并接受邀请。无需手填用户名、加入组织、自己建仓或 Fork，也无需安装 GitHub CLI 或配置 Token。
